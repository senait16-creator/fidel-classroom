...
// flow launched the game — the Letter Board's practice sheet
// (embeddedActiveFamily set) or the Competition family detail screen
// (activeChallengeFamilyObj set). Route back to whichever one is live.
